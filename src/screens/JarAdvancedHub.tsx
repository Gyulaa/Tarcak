...
const styles = StyleSheet.create({
  ...
  lead: { fontSize: 15, color: '#555', lineHeight: 22, marginBottom: 18 },
  muted: { color: '#666', fontSize: 15, textAlign: 'center', marginTop: 12 },
  mutedSmall: { color: '#888', fontSize: 13, marginBottom: 12 },
  primaryBtn: {
    marginTop: 16,
  ...
  addBtnText: { color: '#fff', fontFamily: font.bold, fontSize: 16 },
  row: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  rowCode: { fontFamily: font.bold, fontSize: 18, color: '#222' },
  rowSub: { fontSize: 13, color: '#666', marginTop: 4 },
  removeHit: { paddingVertical: 8, paddingLeft: 12 },
  removeText: { color: '#b00020', fontFamily: font.semibold, fontSize: 14 },
  modalOverlay: {
    flex: 1,
  ...
  pickerName: { fontFamily: font.bold, fontSize: 17, color: '#222' },
  pickerSub: { fontSize: 13, color: '#666', marginTop: 2 },
